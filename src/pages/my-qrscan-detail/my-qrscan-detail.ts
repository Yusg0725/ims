...
@IonicPage()
@Component({
  selector: 'page-my-qrscan-detail',
  templateUrl: 'my-qrscan-detail.html',
})
export class MyQrscanDetailPage {
  //控制连扫按钮选中颜色
  ...
  constructor(private vibrate: Vibration,public navCtrl: NavController, public navParams: NavParams, private qrScanner: QRScanner, private viewCtrl: ViewController) {
    //默认为false
    this.light = false;
